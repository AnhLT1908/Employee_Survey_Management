        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuestionBanks_Skills_SkillId",
                        column: x => x.SkillId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetValue = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Feedbacks_TestAttempts_AttemptId",
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, "Ngôn ngữ C#", "C#" },
                    { 2, "Cơ sở dữ liệu & truy vấn", "SQL" },
                    { 3, "Kiểm thử phần mềm", "QA" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_TestId_TargetType_TargetValue",
                table: "Assignments",
                columns: new[] { "TestId", "TargetType", "TargetValue" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestAttempts_TestId_UserId",
                table: "TestAttempts",
